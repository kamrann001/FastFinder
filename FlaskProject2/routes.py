...
from FlaskProject2.Original.webdrive import displayAmazon, displayTapaz, displayAliexpress
...
def home():
    if request.method == "POST":
        ...
        amazon_products = displayAmazon(item, sort_style, amazon, currency, min_price, max_price)
        tapaz_products = displayTapaz(item, sort_style, tapaz, currency, min_price, max_price)
